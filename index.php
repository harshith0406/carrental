...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Unlock Your Wheels</h2>
      <p>"Unlock your wheels to boundless adventures, where every turn leads to new discoveries. With our diverse fleet, your journey awaits – start exploring today!"</p>
    </div>
    <div class="row"> 
